> 📢 This Helm chart is donated to Microsoft as a basis for the official Helm chart which you can find [here](https://github.com/Azure/api-management-self-hosted-gateway).
